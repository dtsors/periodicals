...
<div class="col-7">
    ...
    <form action="add/periodical" method="post">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="description" placeholder="<l:translate key="Description"/>"></textarea>
        </div>
        <div class="form-group">
            <label class="form-control-label"><l:translate key="IssuesPerMonth"/></label>
            <input type="number" min="1" max="31" step="1" class="form-control" name="issuesPerMonth" placeholder="<l:translate key="IssuesPerMonth"/>">
        </div>
        <div class="form-group">
            <label class="form-control-label"><l:translate key="Cost"/></label>
            <input type="number" min="0.1" max="99999.99" step="0.01" class="form-control" name="cost" placeholder="<l:translate key="Cost"/>">
        </div>
